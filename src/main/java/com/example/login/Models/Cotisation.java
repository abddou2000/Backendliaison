...
public class Cotisation {
    ...
    public Cotisation(String idCotisation, TypeCotisation typeCotisationRef,
    ...
    public String toString() {
        return "Cotisation{" +
                ...
                ", typeCotisationRef=" + (typeCotisationRef != null ? typeCotisationRef.getNomTypeCotisation() : "null") +
